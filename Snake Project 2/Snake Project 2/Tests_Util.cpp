...
GlobalParams getTestGlobalParams()
{
	...
	params
		...
		.setTextColor(Color ({ .r = 255, .g = 255, .b = 255, .a = 100 }))
		...
		.setEmptyTileColor(Color ({ .r = 81, .g = 53, .b = 97, .a = 100 }) )
		.setTimeElapsedRect(Rect ({ .x = params.GAME_GRID_LEFT_BORDER - 100, .y = params.GAME_GRID_UPPER_BORDER - 100, .w = 200, .h = 50 }) )
		.setCollectedApplesRect(Rect ({ .x = params.GAME_GRID_RIGHT_BORDER - 100, .y = params.GAME_GRID_UPPER_BORDER - 100, .w = 200, .h = 50 }) )
		.setGameOverRect(Rect ({ .x = (params.GAME_WINDOW_W - 600) / 2, .y = (params.GAME_WINDOW_H - 200) / 2, .w = 600, .h = 200 }) )
